...
go generate ./pkg/... ./cmd/... ./contrib/gcppubsub/pkg/... ./contrib/camel/pkg/... ./contrib/kafka/pkg/... ./contrib/awssqs/pkg/... ./contrib/gitlab/pkg/...

API_DIRS=(pkg contrib/gcppubsub/pkg contrib/camel/pkg contrib/kafka/pkg contrib/awssqs/pkg contrib/gitlab/pkg)
