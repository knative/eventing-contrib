...
go generate ./pkg/... ./cmd/... ./contrib/github/pkg/... ./contrib/gcppubsub/pkg/... ./contrib/camel/pkg/... ./contrib/kafka/pkg/... ./contrib/awssqs/pkg/...

API_DIRS=(contrib/github/pkg contrib/gcppubsub/pkg contrib/camel/pkg contrib/kafka/pkg contrib/awssqs/pkg)
