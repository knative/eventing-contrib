...
go generate ./pkg/... ./cmd/... ./contrib/gcppubsub/pkg/... ./contrib/camel/pkg/... ./contrib/bitbucket/pkg/...

API_DIRS=(pkg contrib/gcppubsub/pkg contrib/camel/pkg contrib/bitbucket/pkg)
