...
go generate ./pkg/... ./cmd/... ./contrib/gcppubsub/pkg/... ./contrib/camel/pkg/... ./contrib/kafka/pkg/... ./contrib/awssqs/pkg/...

API_DIRS=(pkg contrib/gcppubsub/pkg contrib/camel/pkg contrib/kafka/pkg contrib/awssqs/pkg)
