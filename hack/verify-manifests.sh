...
"${REPO_ROOT_DIR}/hack/update-manifests.sh"
echo "Diffing ${REPO_ROOT_DIR} against freshly generated manifests"
ret=0
...
then
  ...
  echo "${REPO_ROOT_DIR} is out of date. Please run hack/update-manifests.sh"
  exit 1
fi
