...
import (
	...
	"knative.dev/eventing-contrib/couchdb/importer/pkg/client/clientset/versioned/scheme"
)

type SourcesV1alpha1Interface interface {
	RESTClient() rest.Interface
	CouchDbImportersGetter
}
...
func (c *SourcesV1alpha1Client) CouchDbImporters(namespace string) CouchDbImporterInterface {
	return newCouchDbImporters(c, namespace)
}
