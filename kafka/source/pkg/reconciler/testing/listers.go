...
import (
	...
	kafkav1alpha1 "knative.dev/eventing-contrib/kafka/source/pkg/apis/sources/v1alpha1"
	fakekafkaclientset "knative.dev/eventing-contrib/kafka/source/pkg/client/clientset/versioned/fake"
	kafkalisters "knative.dev/eventing-contrib/kafka/source/pkg/client/listers/sources/v1alpha1"
...
func (l *Listers) GetKafkaSourceLister() kafkalisters.KafkaSourceLister {
	return kafkalisters.NewKafkaSourceLister(l.indexerFor(&kafkav1alpha1.KafkaSource{}))
}
