...
func Get(ctx context.Context) v1beta1.KafkaBindingInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-contrib/kafka/source/pkg/client/informers/externalversions/bindings/v1beta1.KafkaBindingInformer from context.")
	}
