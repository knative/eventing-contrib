...
import (
	...
	kafkabinding "knative.dev/eventing-contrib/kafka/source/pkg/client/injection/reconciler/bindings/v1alpha1/kafkabinding"
...
// reason KafkaBindingReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "KafkaBindingReconciled", "KafkaBinding reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for KafkaBinding resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ kafkabinding.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ kafkabinding.Finalizer = (*Reconciler)(nil)
...
//var _ kafkabinding.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ kafkabinding.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.KafkaBinding) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.KafkaBinding) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.KafkaBinding) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.KafkaBinding) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
