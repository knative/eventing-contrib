...
const (
	defaultControllerAgentName = "kafkabinding-controller"
	defaultFinalizerName       = "kafkabindings.bindings.knative.dev"
	defaultQueueName           = "kafkabindings"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:        kafkabindingInformer.Lister(),
		Recorder:      recorder,
		reconciler:    r,
