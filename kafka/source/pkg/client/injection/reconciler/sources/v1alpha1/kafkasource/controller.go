...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/kafka/source/pkg/client/clientset/versioned/scheme"
	injectionclient "knative.dev/eventing-contrib/kafka/source/pkg/client/injection/client"
	kafkasource "knative.dev/eventing-contrib/kafka/source/pkg/client/injection/informers/sources/v1alpha1/kafkasource"
...
const (
	defaultControllerAgentName = "kafkasource-controller"
	defaultFinalizerName       = "kafkasources.sources.knative.dev"
	defaultQueueName           = "kafkasources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kafkasourceInformer := kafkasource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     kafkasourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
