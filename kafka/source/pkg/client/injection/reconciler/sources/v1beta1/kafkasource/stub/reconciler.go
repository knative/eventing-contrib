...
import (
	...
	kafkasource "knative.dev/eventing-contrib/kafka/source/pkg/client/injection/reconciler/sources/v1beta1/kafkasource"
...
// reason KafkaSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "KafkaSourceReconciled", "KafkaSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for KafkaSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ kafkasource.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ kafkasource.Finalizer = (*Reconciler)(nil)
...
//var _ kafkasource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ kafkasource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1beta1.KafkaSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1beta1.KafkaSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1beta1.KafkaSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1beta1.KafkaSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
