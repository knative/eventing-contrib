...
type KafkaSourceInterface interface {
	Create(*v1beta1.KafkaSource) (*v1beta1.KafkaSource, error)
	Update(*v1beta1.KafkaSource) (*v1beta1.KafkaSource, error)
	UpdateStatus(*v1beta1.KafkaSource) (*v1beta1.KafkaSource, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.KafkaSource, error)
	List(opts v1.ListOptions) (*v1beta1.KafkaSourceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaSource, err error)
...
func (c *kafkaSources) Get(name string, options v1.GetOptions) (result *v1beta1.KafkaSource, err error) {
...
func (c *kafkaSources) List(opts v1.ListOptions) (result *v1beta1.KafkaSourceList, err error) {
...
func (c *kafkaSources) Create(kafkaSource *v1beta1.KafkaSource) (result *v1beta1.KafkaSource, err error) {
	result = &v1beta1.KafkaSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kafkasources").
...
func (c *kafkaSources) Update(kafkaSource *v1beta1.KafkaSource) (result *v1beta1.KafkaSource, err error) {
	result = &v1beta1.KafkaSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kafkasources").
...
func (c *kafkaSources) UpdateStatus(kafkaSource *v1beta1.KafkaSource) (result *v1beta1.KafkaSource, err error) {
	result = &v1beta1.KafkaSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kafkasources").
...
func (c *kafkaSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaSource, err error) {
	result = &v1beta1.KafkaSource{}
