...
func (c *FakeKafkaBindings) Get(name string, options v1.GetOptions) (result *v1beta1.KafkaBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaBindings) List(opts v1.ListOptions) (result *v1beta1.KafkaBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaBindings) Create(kafkaBinding *v1beta1.KafkaBinding) (result *v1beta1.KafkaBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaBindings) Update(kafkaBinding *v1beta1.KafkaBinding) (result *v1beta1.KafkaBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaBindings) UpdateStatus(kafkaBinding *v1beta1.KafkaBinding) (*v1beta1.KafkaBinding, error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaBinding, err error) {
	obj, err := c.Fake.
