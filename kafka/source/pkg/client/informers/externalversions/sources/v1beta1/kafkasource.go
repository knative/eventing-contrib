...
import (
	...
	v1beta1 "knative.dev/eventing-contrib/kafka/source/pkg/client/listers/sources/v1beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourcesV1beta1().KafkaSources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourcesV1beta1().KafkaSources(namespace).Watch(options)
			},
		},
