...
import (
	...
	v1beta1 "knative.dev/eventing-contrib/kafka/source/pkg/client/listers/bindings/v1beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BindingsV1beta1().KafkaBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BindingsV1beta1().KafkaBindings(namespace).Watch(options)
			},
		},
