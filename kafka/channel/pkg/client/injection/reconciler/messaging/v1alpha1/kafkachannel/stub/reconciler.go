...
import (
	...
	kafkachannel "knative.dev/eventing-contrib/kafka/channel/pkg/client/injection/reconciler/messaging/v1alpha1/kafkachannel"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.KafkaChannel) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.KafkaChannel) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.KafkaChannel) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.KafkaChannel) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
