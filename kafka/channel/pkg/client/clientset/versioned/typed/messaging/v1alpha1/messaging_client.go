...
import (
	v1alpha1 "github.com/knative/eventing-contrib/kafka/channel/pkg/apis/messaging/v1alpha1"
	"github.com/knative/eventing-contrib/kafka/channel/pkg/client/clientset/versioned/scheme"
...
func (c *MessagingV1alpha1Client) KafkaChannels(namespace string) KafkaChannelInterface {
	return newKafkaChannels(c, namespace)
}
