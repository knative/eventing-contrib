...
func (c *FakeKafkaChannels) Get(name string, options v1.GetOptions) (result *v1beta1.KafkaChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) List(opts v1.ListOptions) (result *v1beta1.KafkaChannelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) Create(kafkaChannel *v1beta1.KafkaChannel) (result *v1beta1.KafkaChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) Update(kafkaChannel *v1beta1.KafkaChannel) (result *v1beta1.KafkaChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) UpdateStatus(kafkaChannel *v1beta1.KafkaChannel) (*v1beta1.KafkaChannel, error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaChannel, err error) {
	obj, err := c.Fake.
