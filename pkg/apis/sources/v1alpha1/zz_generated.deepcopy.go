...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BitBucketSecretValueFromSource) DeepCopyInto(out *BitBucketSecretValueFromSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BitBucketSecretValueFromSource.
func (in *BitBucketSecretValueFromSource) DeepCopy() *BitBucketSecretValueFromSource {
	if in == nil {
		return nil
	}
	out := new(BitBucketSecretValueFromSource)
	in.DeepCopyInto(out)
	return out
}
