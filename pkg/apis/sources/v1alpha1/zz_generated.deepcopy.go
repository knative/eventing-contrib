...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeSource) DeepCopyInto(out *EdgeSource) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeSource.
func (in *EdgeSource) DeepCopy() *EdgeSource {
	if in == nil {
		return nil
	}
	out := new(EdgeSource)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *EdgeSource) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeSourceList) DeepCopyInto(out *EdgeSourceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]EdgeSource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeSourceList.
func (in *EdgeSourceList) DeepCopy() *EdgeSourceList {
	if in == nil {
		return nil
	}
	out := new(EdgeSourceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *EdgeSourceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeSourceSpec) DeepCopyInto(out *EdgeSourceSpec) {
	*out = *in
	if in.Sink != nil {
		in, out := &in.Sink, &out.Sink
		*out = new(v1.ObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeSourceSpec.
func (in *EdgeSourceSpec) DeepCopy() *EdgeSourceSpec {
	if in == nil {
		return nil
	}
	out := new(EdgeSourceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeSourceStatus) DeepCopyInto(out *EdgeSourceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make(duckv1alpha1.Conditions, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeSourceStatus.
func (in *EdgeSourceStatus) DeepCopy() *EdgeSourceStatus {
	if in == nil {
		return nil
	}
	out := new(EdgeSourceStatus)
	in.DeepCopyInto(out)
	return out
}
