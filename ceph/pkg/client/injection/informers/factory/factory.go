...
import (
	...
	externalversions "knative.dev/eventing-contrib/ceph/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-contrib/ceph/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
