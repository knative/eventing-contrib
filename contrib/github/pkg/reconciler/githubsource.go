...
import (
	...
	sourcesv1alpha1 "knative.dev/eventing-contrib/contrib/github/pkg/apis/sources/v1alpha1"
	"knative.dev/eventing-contrib/contrib/github/pkg/reconciler/resources"
