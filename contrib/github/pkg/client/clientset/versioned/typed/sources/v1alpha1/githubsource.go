...
import (
	...
	v1alpha1 "knative.dev/eventing-contrib/contrib/github/pkg/apis/sources/v1alpha1"
	scheme "knative.dev/eventing-contrib/contrib/github/pkg/client/clientset/versioned/scheme"
)
