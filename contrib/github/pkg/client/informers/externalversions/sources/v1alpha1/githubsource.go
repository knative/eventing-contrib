...
import (
	...
	versioned "knative.dev/eventing-contrib/contrib/github/pkg/client/clientset/versioned"
	internalinterfaces "knative.dev/eventing-contrib/contrib/github/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/eventing-contrib/contrib/github/pkg/client/listers/sources/v1alpha1"
)
