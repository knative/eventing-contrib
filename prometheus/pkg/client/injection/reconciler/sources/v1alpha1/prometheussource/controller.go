...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/prometheus/pkg/client/clientset/versioned/scheme"
	injectionclient "knative.dev/eventing-contrib/prometheus/pkg/client/injection/client"
	prometheussource "knative.dev/eventing-contrib/prometheus/pkg/client/injection/informers/sources/v1alpha1/prometheussource"
...
const (
	defaultControllerAgentName = "prometheussource-controller"
	defaultFinalizerName       = "prometheussources.sources.knative.dev"
	defaultQueueName           = "prometheussources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	prometheussourceInformer := prometheussource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     prometheussourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
