...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AwsSqsSourceReconciled", "AwsSqsSource reconciled: \"%s/%s\"", namespace, name)
}
...
//var _ awssqssource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ awssqssource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AwsSqsSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AwsSqsSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
