...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/awssqs/pkg/client/clientset/versioned/scheme"
	injectionclient "knative.dev/eventing-contrib/awssqs/pkg/client/injection/client"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     awssqssourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
