...
// Reconciler implements controller.Reconciler for GitHubSource resources.
...
//var _ githubsource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ githubsource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.GitHubSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.GitHubSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.GitHubSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
