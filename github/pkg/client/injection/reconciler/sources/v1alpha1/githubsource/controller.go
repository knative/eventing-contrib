...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/github/pkg/client/clientset/versioned/scheme"
	injectionclient "knative.dev/eventing-contrib/github/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "githubsource-controller"
	defaultFinalizerName       = "githubsources.sources.knative.dev"
	defaultQueueName           = "githubsources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	githubsourceInformer := githubsource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     githubsourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
